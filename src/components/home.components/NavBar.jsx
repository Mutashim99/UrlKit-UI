      ...
      <div className="flex items-center justify-between h-16 px-4">
        ...
        {loading ? (
          ...
          <div className="gap-6 items-center justify-center hidden md:flex">
            ...
            <Link
              to="/blogs"
              className="text-white hover:text-[#144EE3] text-[16px] font-medium"
            >
              Blogs
            </Link>
            <Link
          ...
          (isAuthenticated ? (
            ...
            >
              <div className="text-white text-center flex flex-col items-center justify-center gap-6 w-full">
                ...
                <Link
                  to="/blogs"
                  className="text-lg font-medium hover:text-[#144EE3]"
                >
                  Blogs
                </Link>
                <Link
            ...
            >
              ...
              <Link
                to="/blogs"
                className="text-lg font-medium hover:text-[#144EE3] text-center"
              >
                Blogs
              </Link>
              <Link
