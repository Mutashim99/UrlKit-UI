...
const DashboardNav = () => {
  return (
    <div className="relative flex flex-col gap-7  sm:h-16 sm:justify-center">
      ...
      {/* Input: centered on desktop, below on mobile */}
      <div className=" text-white w-full sm:absolute flex flex-col gap-4 sm:left-1/2 sm:top-5/3 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:w-[50%]">
        <UrlInput />
      </div>
    </div>
  );
