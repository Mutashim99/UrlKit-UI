...
const Dashboard = () => {
  return (
    <div className="w-full bg-[#151A24]  text-[#C9CED6] relative flex flex-col">
      <div
      ...
      <div
        className="hidden md:block md:absolute md:top-0 md:left-0 h-screen w-full z-10 bg-contain bg-no-repeat  bg-center"
        style={{ backgroundImage: `url(${cubes})` }}
      ></div>

      <div className="w-full relative z-20  bg-[#0b101b77] ">
      ...
      <div className="w-full relative z-20 ">
        <Tabs defaultValue="My Links" className="w-full flex">
          <div className="w-full  bg-[#181E29]  flex items-center justify-center">
            <TabsList className="flex gap-2 md:gap-6  bg-transparent sm:h-[60px] h-[45px]">
              <TabsTrigger
                value="My Links"
